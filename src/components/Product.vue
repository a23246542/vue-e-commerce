            ...
            <tbody>
                <tr v-for="(item) in products" :key=item.id>
                    ...
                    <td>
                        ...
                        @click="productModal(false,item)"
                        >編輯</button>
                    </td>
                    <td>
                        <button class="btn btn-outline-primary btn-sm"
                        @click="delProductModal(item.id)"
                        >刪除</button>
                    </td>
                </tr>
            </tbody>
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        type="unit" class="form-control" id="unit" placeholder="請輸入單位">
                                    </div>
                                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            delProduct(){
                const api = `${process.env.VUE_APP_API}api/${process.env.VUE_APP_CUSTOMAPI}/admin/product/${this.tempProduct.id}`;
